...
const Features = () => {
  return (
    <section>
        ...
        <div className='flex flex-col border border-gray-500 items-center w-60 h-64 p-4 rounded-lg'>
        ...
        <div className='flex flex-col border border-y-gray-500 items-center w-60 h-64 p-4 rounded-lg'>
